...
[task_local]
#东东萌宠
43 0,8,17,22 * * * jd_pet_help.js, tag=东东萌宠, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdmc.png, enabled=true

=================================Loon===================================
[Script]
cron "43 0,8,17,22 * * *" script-path=jd_pet_help.js,tag=东东萌宠

===================================Surge================================
东东萌宠 = type=cron,cronexp="43 0,8,17,22 * * *",wake-system=1,timeout=3600,script-path=jd_pet_help.js

====================================小火箭=============================
东东萌宠 = type=cron,script-path=jd_pet_help.js, cronexpr="43 0,8,17,22 * * *", timeout=3600, enable=true
