...
================Loon==============
[Script]
cron "13 1,17,20 * * *" script-path=jd_xmf.js, tag=京东小魔方

===============Surge=================
京东小魔方 = type=cron,cronexp="13 1,17,20 * * *",wake-system=1,timeout=3600,script-path=jd_xmf.js

============小火箭=========
京东小魔方 = type=cron,script-path=jd_xmf.js, cronexpr=23 1,17,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东小魔方');
