...
!(async () => {
    ...
    $.shareCoseList = [...new Set([...$.shareCoseList,'VFGoqpYwPRzeN_faC-N_Qdhpnb27v8KRLoFTwRkGYyw','26MGOrZcCA8WbN3w_gf3Snl6CAmcmk0gmssY4k1bO9c','UV7rZ0tCeQiJYl2lYhXy2Bp9igNlmOsl9gxvfwe5erE','LdOuQ54xjoYfaJNIulDyVA'])]
    //去助力与开箱
    for (let i = 0; i < cookiesArr.length; i++) {
        cookie = cookiesArr[i];
        if (cookie) {
