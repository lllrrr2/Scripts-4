...
[task_local]
#城城领现金助力
0 0,16,23 9-13 12 * jd_cityzl.js, tag=城城领现金助力, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
...
let exchangeFlag = $.isNode() ? (process.env.JD_CITY_EXCHANGE === "true" ? true : true) : ($.getdata('jdJxdExchange') === "true" ? true : false)  //是否开启自动抽奖，建议活动快结束开启，默认关闭
...
let inviteCodes = ['ryUXaoNZTBDY0PCG9uQoSvOe7RF_sHr', 'ryUXv0FNzAVMkPHSY7N_-YfC6gTImEY', 'ryUXvlebmBHNUPHTonN9c-BqbeMKm3B']
!(async () => {
  if (!cookiesArr[0]) {
