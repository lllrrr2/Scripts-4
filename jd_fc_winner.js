...
[task_local]
#发财大赢家之翻翻乐
20 0-20/4 * * * jd_big_winner.js, tag=发财大赢家之翻翻乐, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "20 0-20/4 * * *" script-path=jd_big_winner.js,tag=发财大赢家之翻翻乐
                    ...
                    if (data.code === 0 && data.data) {
                        if (functionid != "gambleObtainReward") {
                            ...
                            if (data.data.rewardState === 3) {
                                console.log("翻倍失败啦...")
                                console.log(`当前：${data.data.rewardValue} 翻倍失败啦`)
                                $.canDraw = false
								$.canReward = false;
