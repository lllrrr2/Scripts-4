...
[task_local]
#JOY庄园每日任务
11 0,12,21 * * * jd_joymanor_task.js, tag=JOY庄园每日任务, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_joymanor_task.png, enabled=true

================Loon==============
[Script]
cron "11 0,12,21 * * *" script-path=jd_joymanor_task.js,tag=JOY庄园每日任务

===============Surge=================
JOY庄园每日任务 = type=cron,cronexp="11 0,12,21 * * *",wake-system=1,timeout=3600,script-path=jd_joymanor_task.js
